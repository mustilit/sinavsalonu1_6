...
export default function Home() {
  ...
  const handleSearch = (e) => {
    ...
    window.location.href = createPageUrl("Explore") + `?q=${encodeURIComponent(searchQuery)}`;
  };

  const handleLogin = (userType) => {
    localStorage.setItem('preferred_user_type', userType);
    base44.auth.redirectToLogin(createPageUrl("Explore"));
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {user && (
        ...
        `}>
          <Sidebar user={user} currentPage="Home" />
        </div>
      )}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="rounded-3xl p-12 text-center" style={{ backgroundColor: '#0000CD' }}>
              ...
              <Button 
                ...
                style={{color: '#0000CD'}}
                onClick={() => {
                  localStorage.setItem('preferred_user_type', 'candidate');
            ...
            <div className="rounded-3xl p-12 text-center" style={{ backgroundColor: '#0000CD' }}>
              ...
              <Button 
                ...
                style={{color: '#0000CD'}}
                onClick={() => {
                  localStorage.setItem('preferred_user_type', 'educator');
                  base44.auth.redirectToLogin();
                }}
              >
                Hemen Başla
