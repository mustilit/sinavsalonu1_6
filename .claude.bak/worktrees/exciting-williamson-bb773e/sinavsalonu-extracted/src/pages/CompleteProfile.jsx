...
export default function CompleteProfile() {
  ...
  useEffect(() => {
    const loadUser = async () => {
      try {
        ...
        // Eğer profil zaten tamamlanmışsa, explore sayfasına yönlendir
        ...
        setFormData({
          ...
          city: userData.city || "",
          country_code: userData.country_code || "+90"
        });
        
        // Eğer Yurt Dışı seçilmişse flag'i set et
        if (userData.city === "Yurt Dışı") {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const preferredUserType = localStorage.getItem('preferred_user_type');
