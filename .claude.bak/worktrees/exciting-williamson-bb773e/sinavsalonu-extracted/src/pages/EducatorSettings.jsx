...
export default function EducatorSettings() {
    ...
    const loadUser = async () => {
      try {
        ...
        const initialData = {
          ...
          google_scholar_url: userData.google_scholar_url || "",
          cv_url: userData.cv_url || "",
          profile_image_url: userData.profile_image_url || "",
          specialized_exam_types: userData.specialized_exam_types || [],
  ...
  const resubmitApplicationMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      const updatedUser = { ...user, educator_status: "pending", rejection_reason: null };
      setUser(updatedUser);
      queryClient.invalidateQueries({ queryKey: ["educatorUser"] });
    },
  });
