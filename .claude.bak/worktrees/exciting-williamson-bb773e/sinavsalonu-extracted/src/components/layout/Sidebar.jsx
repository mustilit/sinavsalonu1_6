...
export default function Sidebar({ user, currentPage }) {
  ...
  const isApprovedEducator = isEducator && user?.educator_status === "approved";
  const isAdmin = user?.role === "admin";

  const candidateLinks = [
    { name: "Ana Sayfa", page: "Home", icon: Home },
    { name: "Testleri Keşfet", page: "Explore", icon: Search },
    { name: "Testlerim", page: "MyTests", icon: BookOpen },
    { name: "Sonuçlarım", page: "MyResults", icon: BarChart3 },
